              ...
              ? <Menu.Menu position='right'>
                  <Dropdown item text='My Account'>
                    <Dropdown.Menu>
                      ...
                      />
                      <Dropdown.Header
                        content={'LOA: ' + user.profile.LOA}
                      />
                      <Dropdown.Header
                        content={'MARK: ' + user.profile.MARK}
                      />
                      <Dropdown.Divider />
                      <Dropdown.Item as={Link} to='/request-loan'>Request loan</Dropdown.Item>
                      {/* <Dropdown.Item as={Link} to='/pay-collateral'>Pay collateral</Dropdown.Item> */}
                      <Dropdown.Item as={Link} to='/repay-loan'>Repay loan</Dropdown.Item>
